...
import com.gochicken3.mobilehelper.bean.CommLockInfo;
...
import com.gochicken3.mobilehelper.widget.DialogPermission;
...
public class AppLockFragment extends Fragment implements AppLockContract.View {
    ...
    @BindView(R.id.applock_searchview)
    SearchView applockSearchview;
    @BindView(R.id.applock_searchview_rl)
    RelativeLayout applockSearchviewRl;
    @BindView(R.id.applock_rv)
