...
import com.gochicken3.mobilehelper.applock.gesturelock.createlock.GestureCreateFragment;
import com.gochicken3.mobilehelper.base.Constant;
import com.gochicken3.mobilehelper.main.MainActivity;
import com.gochicken3.mobilehelper.manager.CommLockInfoManager;
...
import com.gochicken3.mobilehelper.util.LockUtil;
import com.gochicken3.mobilehelper.util.SpHelper;
import com.gochicken3.mobilehelper.util.ToastUtil;
import com.gochicken3.mobilehelper.widget.LockPatternView;
...
public class GestureUnlockFragment extends Fragment implements GestureUnlockContract.View {
    ...
    @BindView(R.id.gestureunlock_app_logo_icon)
    ImageView gestureunlockAppLogoIcon;
    @BindView(R.id.gestureunlock_app_lable)
    TextView gestureunlockAppLable;
    @BindView(R.id.gestureunlock_app_unlock_icon)
    ImageView gestureunlockAppUnlockIcon;
    @BindView(R.id.gestureunlock_app_unlock_name)
    TextView gestureunlockAppUnlockName;
    @BindView(R.id.gestureunlock_app_unlock_top)
    TextView gestureunlockAppUnlockTop;
    @BindView(R.id.gestureunlock_app_unlock_lpv)
    LockPatternView mLockPatternView;
    @BindView(R.id.gestureunlock_unlock_layout)
