package com.sharkwang8.phoneassistant.widget;
...
public class RadarScanView extends View {
    ...
    public RadarScanView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.RadarScanView);

        mTextSize = a.getDimension(R.styleable.RadarScanView_android_textSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,40,getDisplayMetrics()));
        mTextColor = a.getColor(R.styleable.RadarScanView_android_textColor,mTextColor);
        mText = a.getString(R.styleable.RadarScanView_android_text);

        mLabelTextSize = a.getDimension(R.styleable.RadarScanView_labelTextSize,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,16,getDisplayMetrics()));
        mLabelTextColor = a.getColor(R.styleable.RadarScanView_labelTextColor,mTextColor);
        mLabelText = a.getString(R.styleable.RadarScanView_labelText);
        mFormat = a.getString(R.styleable.RadarScanView_format);
        if(TextUtils.isEmpty(mFormat)){
            mFormat = DEFAULT_FORMAT;
        }

        mSideColor = a.getColor(R.styleable.RadarScanView_sideColor,mSideColor);
        mOutsideBackgroundColor = a.getColor(R.styleable.RadarScanView_outsideBackgroundColor,mOutsideBackgroundColor);
        mInsideBackgroundColor = a.getColor(R.styleable.RadarScanView_insideBackgroundColor,mInsideBackgroundColor);

        mDuration = a.getInt(R.styleable.RadarScanView_duration,mDuration);

        mTextOffsetY = a.getDimension(R.styleable.RadarScanView_textOffsetY,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,12,getDisplayMetrics()));
        mLabelTextOffseY = a.getDimension(R.styleable.RadarScanView_labelTextOffsetY,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,36,getDisplayMetrics()));
        mCircleColor = a.getColor(R.styleable.RadarScanView_circleColor,mCircleColor);
        mLineColor = a.getColor(R.styleable.RadarScanView_lineColor,mLineColor);
        mRotate = a.getInt(R.styleable.RadarScanView_rotate,mRotate);
        mIsShowLine = a.getBoolean(R.styleable.RadarScanView_showLine,mIsShowLine);
        mIsShowText = a.getBoolean(R.styleable.RadarScanView_showText,mIsShowText);
        mIsShowLabel = a.getBoolean(R.styleable.RadarScanView_showLabel,mIsShowLabel);
        mScanTime = a.getInt(R.styleable.RadarScanView_scanTime,mScanTime);

        mInsideStrokeWidth = a.getDimension(R.styleable.RadarScanView_insideStrokeWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,3,getDisplayMetrics()));
        mOutsideStrokeWidth = a.getDimension(R.styleable.RadarScanView_outsideStrokeWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,8,getDisplayMetrics()));
        mLineStrokeWidth = a.getDimension(R.styleable.RadarScanView_lineStrokeWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,0.3f,getDisplayMetrics()));
        a.recycle();
    }
