...
import com.sharkwang8.phoneassistant.applock.gesturelock.resetlock.ResetPasswordActivity;
import com.sharkwang8.phoneassistant.applock.gesturelock.resetlock.ResetPasswordFragment;
...
public class SettingLockFragment extends Fragment implements SettingLockContract.View {
    ...
    @BindView(R.id.setting_lock_applock_state_tv)
    TextView settingLockApplockStateTv;
    @BindView(R.id.setting_lock_cb)
    CheckBox settingLockCb;
    @BindView(R.id.setting_lock_lockscreen_tv)
    TextView settingLockLockscreenTv;
    @BindView(R.id.setting_lock_lockscreen_cb)
    CheckBox settingLockLockscreenCb;
    @BindView(R.id.setting_lock_reset_password_tv)
    ...
    @OnClick(R.id.setting_lock_reset_password_tv)
    public void onClick() {
