package com.sharkwang8.phoneassistant.tasks;
...
import com.sharkwang8.phoneassistant.bean.ApkInformBean;
...
import com.sharkwang8.phoneassistant.util.FileUtil;
...
public class OverScanTask extends AsyncTask<Void, Void, Void> {
    ...
    private boolean compareToInstall(int versionCode, String packageName) {
        PackageInfo info;
        try {
            info = App.getmContext().getPackageManager().getPackageInfo(packageName, 0);
