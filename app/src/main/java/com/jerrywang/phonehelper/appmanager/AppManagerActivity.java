...
public class AppManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManagerFragment loginFragment = (AppManagerFragment) getSupportFragmentManager()
                .findFragmentById(R.id.fl_main);

        if (loginFragment == null) {
            loginFragment = AppManagerFragment.newInstance();
        ...
        new AppManagerPresenter(loginFragment);
    }
